...
sys.stdout = open('/home/don/garage/data_logger.log', 'at')
sys.stderr = open('/home/don/garage/data_logger.err', 'at')
...
class Data:
    ...
    def __str__(self):
        return ('Data(sample_date: '  + str(self.sample_date) + "\n" + \
                '     temp_garage: '  + str(self.temp_garage) + "\n" + \
