...
# -*- coding: utf-8 -*-
#
# data_sender.py - Data sending program for garage data logging
...
sys.stdout = open('/home/don/garage/data_sender.log', 'at')
sys.stderr = open('/home/don/garage/data_sender.err', 'at')

url = 'http://192.168.0.70:3000/garage_data'
...
def to_json(sample_date, temp_garage, temp_rpi):
  return ('{"sample_date": ' + to_nvl(sample_date) + ',' + \
          ' "temp_garage": ' + to_nvl(temp_garage) + ',' + \
